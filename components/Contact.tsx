  ...
  return (
    <section id="contact" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="bg-indigo-600 rounded-3xl md:rounded-[50px] p-4 md:p-8 lg:p-20 shadow-2xl shadow-indigo-200 relative overflow-hidden">
          {/* Decorative accents */}
          <div className="absolute top-0 right-0 w-64 h-64 bg-white/5 rounded-full -translate-y-1/2 translate-x-1/2"></div>

          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div className="space-y-8 text-white">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif">Să transformăm împreună prezența brandului tău.</h2>
            ...
            <div className="bg-white rounded-2xl md:rounded-3xl p-4 md:p-8 lg:p-10 shadow-lg">
              <h3 className="text-xl md:text-2xl font-bold text-slate-900 mb-4 text-center">Trimite un semnal rapid</h3>
              <div className="flex flex-col gap-3">
                <a
                  href={`https://wa.me/${CONTACT_INFO.whatsapp}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white font-bold py-3 text-sm rounded-2xl transition-all shadow-md shadow-green-100"
                >
                ...
                <div className="mt-4 pt-4 md:mt-8 md:pt-6 border-t border-slate-100 text-center">
