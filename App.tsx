            ...
            <div className="bg-white p-12 lg:p-20 rounded-[3rem] shadow-2xl shadow-blue-100/50 border border-slate-100 flex flex-col lg:flex-row gap-16 items-center">
               ...
               <div className="lg:w-3/5 space-y-8">
                 ...
                 <p className="text-slate-600 text-xl leading-relaxed">
                   Cu o capacitate nativă de a înțelege publicul-țintă, livrez conținut coerent, relevant și eficient. Sunt orientată spre colaborare, deschisă la feedback și mereu în căutare de rezultate măsurabile.
                 </p>
      ...
      <footer className="py-12 border-t border-slate-100 bg-white">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-slate-400 text-sm">
            © {new Date().getFullYear()} Andreea Iliana. Toate drepturile rezervate.
          </p>
          <div className="flex gap-8 text-sm text-slate-500 font-medium">
            <a href="#despre" className="hover:text-blue-600 transition-colors">Despre</a>
            <a href="#experienta" className="hover:text-blue-600 transition-colors">Experiență</a>
